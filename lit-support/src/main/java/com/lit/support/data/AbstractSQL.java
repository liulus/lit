...
/**
 * 引用 org.apache.ibatis.jdbc.AbstractSQL
 *
 * @author mybatis
 * @version v1.0
 * @see org.apache.ibatis.jdbc.AbstractSQL
...
public abstract class AbstractSQL<T> {
    ...
    private static class SQLStatement {
        ...
        List<String> count = Collections.singletonList("count(*)");
        ...
        private String countSQL(SafeAppendable builder) {
            sqlClause(builder, "SELECT", count, "", "", ", ");
            sqlClause(builder, "FROM", tables, "", "", ", ");
            joins(builder);
            sqlClause(builder, "WHERE", where, "(", ")", " AND ");
            sqlClause(builder, "GROUP BY", groupBy, "", "", ", ");
