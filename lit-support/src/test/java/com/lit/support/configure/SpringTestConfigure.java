package com.lit.support.configure;
...
import com.lit.support.data.jdbc.JdbcRepositoryScan;
 ...
 */
@JdbcRepositoryScan(value = "com.lit.support.jdbc.repository", dataSourceRef = "dataSource")
@Configuration
